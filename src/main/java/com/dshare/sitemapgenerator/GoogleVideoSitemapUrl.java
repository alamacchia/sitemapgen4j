...
public class GoogleVideoSitemapUrl extends WebSitemapUrl {
	...
	public static class Options extends AbstractSitemapUrlOptions<GoogleVideoSitemapUrl, Options> {
		...
		public Options hasVideoContentLoc(boolean hasVideoContentLoc) {
			this.hasVideoContentLoc = hasVideoContentLoc;
			return this;
		}
		
		public Options uploader(String uploader) {
			this.uploader = uploader;
			return this;
		}
		
		public Options uploaderInfo(String uploaderInfo) {
...
//		}
	...
	/** Retrieves whether video content_loc is allowed */
	public Boolean getHasVideoContentLoc() {
		return hasVideoContentLoc;
	}
